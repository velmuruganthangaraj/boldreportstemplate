...
$(document).on("click", "#clear-search,.clear-search,#add-user-clear-search", function () {
...
$(document).on("keydown", "#search-groups, #search-group-users, #searchItems, #search-schedules,#userSearchKey,#groupSearchKey, #search-users, #search-user-permission, #search-group-permission, #search-home-page, #search-items, #search-tenants, #search-app-users, #add-user-search", function (e) {
    $.xhrPool.abortAll();
            ...
            success: function (data) {
                if (data !== undefined) {
                    ...
                    if (data.IsBoldBILicenseExpired && data.IsBoldReportsLicenseExpired) {
                        if (isLicensePage) {
                            warningContent = "Your Bold BI and Bold Reports license has expired. Please upgrade your plan or " + "<a href= '" + boldContactUrl + "' > contact us</a>." + " <span class='close-user-warning-icons su-close'></span>";
                        }
                        else {
                            warningContent = "Your Bold BI and Bold Reports license has expired. Please " + "<a href= '" + manageLicenseUrl + "' >" + "upgrade your plan</a> or " + "<a href= '" + boldContactUrl + "' > contact us</a>." + " <span class='close-user-warning-icons su-close'></span>";
                        }
                    }
                    else if (data.IsBoldBILicenseExpired) {
                        if (isLicensePage) {
                            warningContent = "Your Bold BI license has expired. Please upgrade your plan or " + "<a href= '" + boldContactUrl + "' > contact us</a>." + " <span class='close-user-warning-icons su-close'></span>";
                        }
                        else {
                            warningContent = "Your Bold BI license has expired. Please " + "<a href= '" + manageLicenseUrl + "?product=boldbi' >" + "upgrade your plan</a> or " + "<a href= '" + boldContactUrl + "' > contact us</a>." + " <span class='close-user-warning-icons su-close'></span>";
                        }
                    }
                    else if (data.IsBoldReportsLicenseExpired) {
                        if (isLicensePage) {
                            warningContent = "Your Bold Reports license has expired. Please upgrade your plan or " + "<a href= '" + boldContactUrl + "' > contact us</a>." + " <span class='close-user-warning-icons su-close'></span>";
                        }
                        else {
                            warningContent = "Your Bold Reports license has expired. Please " + "<a href= '" + manageLicenseUrl + "?product=boldreports' >" + "upgrade your plan</a> or " + "<a href= '" + boldContactUrl + "' > contact us</a>." + " <span class='close-user-warning-icons su-close'></span>";
                        }
                    }
