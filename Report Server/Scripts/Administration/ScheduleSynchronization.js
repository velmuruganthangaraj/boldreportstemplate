            ...
            if (data !== null && data !== "") {
                ...
                switch ((item.RecurrenceType).toLowerCase()) {
                    case "hourly":
                        ...
                        editScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + timeText;
                    ...
                    case "daily":
                        ...
                        if (item.Recurrence.DailySchedule.DaysInterval == 1)
                            editScheduleDetail = window.Server.App.LocalizationContent.OccursEveryDay;
                        else
                            editScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + item.Recurrence.DailySchedule.DaysInterval.toString() + window.Server.App.LocalizationContent.Days;
                        break;
                    ...
                    case "dailyweekday":
                        ...
                        editScheduleDetail = window.Server.App.LocalizationContent.OccursEveryWeek;
                        break;
                    ...
                    case "weekly":
                        ...
                        for (var i = 0; i < selectDays.length; i++) {
                            if (selectDays.length == 1 || i == 0)
                                ...
                                daysDetail = daysDetail + window.Server.App.LocalizationContent.And + $(selectDays[i]).siblings("label").text();
                        }
                        if (item.Recurrence.WeeklySchedule.WeeksInterval == 1)
                            editScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + daysDetail;
                        else
                            editScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + item.Recurrence.WeeklySchedule.WeeksInterval.toString() + window.Server.App.LocalizationContent.WeeksOn + daysDetail;
                        break;
                    ...
                    case "monthly":
                        ...
                        editScheduleDetail = window.Server.App.LocalizationContent.OccursDay + item.Recurrence.MonthlySchedule.DayOfMonth.toString() + window.Server.App.LocalizationContent.Every + item.Recurrence.MonthlySchedule.Months.toString() + window.Server.App.LocalizationContent.Month;
                        break;
                    ...
                    case "monthlydow":
                        ...
                        editScheduleDetail = window.Server.App.LocalizationContent.Occurs + item.Recurrence.MonthlyDowSchedule.WeeksOfTheMonth.toString() + " " + $("#monthly-dow-day option:selected").text() + window.Server.App.LocalizationContent.Every + item.Recurrence.MonthlyDowSchedule.Months + window.Server.App.LocalizationContent.Month;
                        break;
                    case "yearly":
                        ...
                        if (item.Recurrence.YearlySchedule.YearsInterval == 1)
                            editScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + item.Recurrence.YearlySchedule.MonthsOfTheYear.toString() + " " + item.Recurrence.YearlySchedule.DayOfMonth.toString();
                        else
                            editScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + item.Recurrence.YearlySchedule.YearsInterval.toString() + window.Server.App.LocalizationContent.Year + item.Recurrence.YearlySchedule.MonthsOfTheYear.toString() + " " + item.Recurrence.YearlySchedule.DayOfMonth.toString();
                        break;
                    ...
                    case "yearlydow":
                        ...
                        if (item.Recurrence.YearlyDowSchedule.YearsInterval == 1)
                            editScheduleDetail = window.Server.App.LocalizationContent.Occurs + item.Recurrence.YearlyDowSchedule.WeeksOfTheMonth.toString() + " " + $("#yearly-dow-day option:selected").text() + " of " + item.Recurrence.YearlyDowSchedule.MonthsOfTheYear.toString();
                        else
                            editScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + item.Recurrence.YearlyDowSchedule.YearsInterval.toString() + window.Server.App.LocalizationContent.Year + item.Recurrence.YearlyDowSchedule.WeeksOfTheMonth.toString() + " " + $("#yearly-dow-day option:selected").text() + " " + window.Server.App.LocalizationContent.Of + " " + item.Recurrence.YearlyDowSchedule.MonthsOfTheYear.toString();
                        break;
                }
                ...
                $(".recurrence-information").html(editScheduleDetail + window.Server.App.LocalizationContent.Effective + item.NextScheduleString);
    ...
    if (validateSchedule()) {
        ...
        switch ($("#recurrence-type").val().toString().toLowerCase()) {
            case "hourly":
                ...
                if (parseInt(timesplit[1]) > 0)
                    timeText += timesplit[1] + " minute(s)";
                addScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + timeText;
                break;
            case "daily":
                if ($("#daily-every-x-days").is(":checked")) {
                    ...
                    if (scheduleItem.RecurrenceInterval == 1)
                        addScheduleDetail = window.Server.App.LocalizationContent.OccursEveryDay;
                    else
                        addScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.Days;
                }
                else {
                    scheduleItem.RecurrenceType = "DailyWeekDay";
                    addScheduleDetail = window.Server.App.LocalizationContent.OccursEveryWeek;
                }
                break;
            case "weekly":
                ...
                if (scheduleItem.RecurrenceInterval == 1)
                    addScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + daysDetail;
                else
                    addScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.WeeksOn + daysDetail;
                break;
            case "monthly":
                if ($("#monthly").is(":checked")) {
                    ...
                    addScheduleDetail = window.Server.App.LocalizationContent.OccursDay + scheduleItem.DaysOfMonth.toString() + window.Server.App.LocalizationContent.Every + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.Month;
                }
                else {
                    ...
                    addScheduleDetail = window.Server.App.LocalizationContent.Occurs + scheduleItem.WeekOfMonth.toString() + " " + $("#monthly-dow-day option:selected").text() + window.Server.App.LocalizationContent.Every + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.Month;
                }
                break;
            case "yearly":
                ...
                if ($("#yearly").is(":checked")) {
                    ...
                    if (scheduleItem.RecurrenceInterval == 1)
                        addScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + scheduleItem.MonthOfYear.toString() + " " + scheduleItem.DaysOfMonth.toString();
                    else
                        addScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.Year + scheduleItem.MonthOfYear.toString() + " " + scheduleItem.DaysOfMonth.toString();
                }
                else {
                    ...
                    if (scheduleItem.RecurrenceInterval == 1)
                        addScheduleDetail = window.Server.App.LocalizationContent.Occurs + scheduleItem.WeekOfMonth.toString() + " " + $("#yearly-dow-day option:selected").text() + " " + window.Server.App.LocalizationContent.Of + " " + scheduleItem.MonthOfYear.toString();
                    else
                        addScheduleDetail = window.Server.App.LocalizationContent.OccursEvery + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.Year + scheduleItem.WeekOfMonth.toString() + " " + $("#yearly-dow-day option:selected").text() + " " + window.Server.App.LocalizationContent.Of + " " + scheduleItem.MonthOfYear.toString();
                }
                break;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (scheduleItem.IsEnabled) {
                    ...
                    $(".recurrence-information").html(addScheduleDetail + window.Server.App.LocalizationContent.Effective + data.StartDateValue);
                }
                SuccessAlert(window.Server.App.LocalizationContent.ScheduleSyncSettings, window.Server.App.LocalizationContent.SettingsSuccessAlert, 7000);
            },
            error: handleAjaxError(),
            complete: function () {
...
function validateSchedule() {
    ...
    if (!startDateTimeObj.model.dateTimeFormat == "h:mm tt") {
        ...
        $("#start-date-validator").html(window.Server.App.LocalizationContent.ScheduleTimeValidator);
            return false;
        } else {
...
function EnableSchedule() {
    ...
    //Related to hourly schdeule.Here we don't show the hourly schedule in UI.Hence commented these lines.
