...
function showSharePermissionContainer() {
    ...
    if (typeof (currentItemDetail.Extension) != "undefined" && currentItemDetail.Extension.toLowerCase() == ".rdl") {
...
function generateEmbedCode(itemDetail) {
    ...
    embedDashboardUrl += $("#embed-dashboard-comments").is(":checked") ? "&report_comments=true" : "";
    ...
    var embedFrameCode = "<iframe src='" + embedDashboardUrl + "' id='report-frame' width='800px' height='600px' allowfullscreen frameborder='0'></iframe>";
