ej.QueryDesigner.Locale['fr-FR'] = {
    ...
    schemaArea: {
        ...
        alertMessage: {
            datasourceAlert: 'Sélectionner une source de données pour configurer le jeu de données de rapport',
            ...
            duplicateDatasetName: 'Le nom spécifié existe déjà dans la liste Ensemble de données',
        ...
        errorMessage: {
            ...
            specifyDatasetName: 'Spécifiez le nom du fichier',
            previewFailed: 'Échec de la visualisation de la table sélectionnée dans l\'ensemble de données',
    ...
    joiner: {
        ...
        errorMessage: {
            removeField: 'Chaque relation doit avoir une condition de champ. Donc, ne permet pas de supprimer ce champ',
    ...
    queryExpression: {
        ...
        errorMessage: {
            ...
            nameAlert: 'Le nom ne doit pas être vide',
            emptyAlert: 'L\'expression ne doit pas être vide',
        ...
        expressions: {
            ...
            lower: 'Renvoie une valeur de chaîne convertie en minuscule à partir d\'une expression de chaîne donnée.',
