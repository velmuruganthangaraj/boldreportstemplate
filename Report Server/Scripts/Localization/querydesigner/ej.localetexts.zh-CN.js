ej.QueryDesigner.Locale['zh-CN'] = {
    ...
    queryExpression: {
        ...
        expressions: {
            ...
            ifNull: '如果表达式是數字 / 串 / 日期，则返回第一个表达式. 如果第一个表达式为NULL，则返回第二个表达式.',
            isNotNull: '如果numeric / 串 / 日期表達式為空，则返回表示false的字符串; 否则表示为true.',
            isNull: '如果numeric / 串 / 日期表達式為空，则返回表示true的字符串; 否则表示false.',
