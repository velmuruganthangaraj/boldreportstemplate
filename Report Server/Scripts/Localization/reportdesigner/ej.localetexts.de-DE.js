ej.ReportDesigner.Locale['de-DE'] = {
    ...
    imageProperty: {
        ...
        appearance: {
            ...
            borderStyle: {
                borderDefaultColor: 'Randfarbe',
                borderDefaultSize: 'Rahmengrösse',
                borderDefaultStyle: 'Rahmenstil',
                borderLeftColor: 'Rahmenfarbe links',
                borderLeftSize: 'Rahmen linke Größe',
                borderLeftStyle: 'Linke Rahmenart',
                borderTopColor: 'Rahmen Top Farbe',
                borderTopSize: 'Rand Top Größe',
                borderTopStyle: 'Rahmen Top Style',
                borderRightColor: 'Rahmenfarbe rechts',
                borderRightSize: 'Rand richtige Größe',
                borderRightStyle: 'Rahmen richtiger Stil',
                borderBottomColor: 'Rahmenfarbe unten',
                borderBottomSize: 'Rand unten Größe',
                borderBottomStyle: 'Rand unten Style'
            }
        },
        size: {
            categoryName: 'Größe',
    ...
    chartProperty: {
        ...
        axis: {
            ...
            lineStyles: {
                ...
                lineSize: 'Liniengröße',
                lineStyle: 'Linienart'
            },
            gridLineStyles: {
                gridLineColor: 'Rasterlinienfarbe',
                gridLineSize: 'Rasterliniengröße',
                gridLineStyle: 'Rasterlinienstil'
            },
            chartTicks: {
    ...
    publishReport: {
        ...
        addCategory: {
            ...
            emptyCategory: 'Bitte geben Sie den Kategorienamen ein',
            saveCategoryError: 'Der Artikelname ist bereits vorhanden',
            categoryCreateError: 'Kategorie konnte nicht im Server erstellt werden',
            saveCatgeory: 'speichern'
        },
        warningMessage: {
    ...
    codeDialog: {
        ...
        classes: {
            ...
            classSuffixTooltip: ' über RDL-Klassen.'
        },
        code: {
            title: 'Code',
            ...
            codeSuffixToolTip: ' über RDL-Code-Modul.'
        },
