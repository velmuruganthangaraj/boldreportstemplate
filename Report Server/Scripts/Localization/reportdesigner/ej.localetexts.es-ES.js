ej.ReportDesigner.Locale['es-ES'] = {
    ...
    imageProperty: {
        ...
        appearance: {
            ...
            borderStyle: {
                borderDefaultColor: 'Color del borde',
                borderDefaultSize: 'Tamaño de borde',
                borderDefaultStyle: 'Estilo de borde',
                borderLeftColor: 'Color de borde izquierdo',
                borderLeftSize: 'Tamaño de borde izquierdo',
                borderLeftStyle: 'Estilo de borde izquierdo',
                borderTopColor: 'Color superior del borde',
                borderTopSize: 'Tamaño superior de borde',
                borderTopStyle: 'Estilo superior de borde',
                borderRightColor: 'Color de borde derecho',
                borderRightSize: 'Tamaño de borde derecho',
                borderRightStyle: 'Estilo de borde derecho',
                borderBottomColor: 'Color de fondo del borde',
                borderBottomSize: 'Tamaño del borde inferior',
                borderBottomStyle: 'Estilo de fondo de borde'
            }
        },
        size: {
            categoryName: 'Tamaño',
    ...
    chartProperty: {
        ...
        axis: {
            ...
            gridLineStyles: {
                gridLineColor: 'Color de línea de rejilla',
                gridLineSize: 'Tamaño de línea de rejilla',
                gridLineStyle: 'Estilo de línea de cuadrícula'
            },
            chartTicks: {
                tickLength: 'Longitud de la garrapata',
                tickWidth: 'Ancho de garrapata'
            }
        },
        gridLine: {
    ...
    publishReport: {
        ...
        addCategory: {
            ...
            emptyCategory: 'Por favor ingrese el nombre de la categoría',
            saveCategoryError: 'El nombre del artículo ya existe',
            categoryCreateError: 'Error al crear categoría en el servidor',
            saveCatgeory: 'Salvar'
        },
        warningMessage: {
    ...
    codeDialog: {
        ...
        classes: {
            ...
            classSuffixTooltip: ' sobre las clases RDL.'
        },
        code: {
            title: 'Código',
            ...
            codeSuffixToolTip: ' sobre el módulo de código RDL.'
        },
