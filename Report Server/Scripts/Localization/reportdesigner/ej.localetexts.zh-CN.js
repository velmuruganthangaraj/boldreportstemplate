ej.ReportDesigner.Locale['zh-CN'] = {
    ...
    imageProperty: {
        ...
        appearance: {
            ...
            borderStyle: {
                borderDefaultColor: '邊框顏色',
                borderDefaultSize: '邊框尺寸',
                borderDefaultStyle: '邊框樣式',
                borderLeftColor: '邊框左側顏色',
                borderLeftSize: '邊框左尺寸',
                borderLeftStyle: '邊框左樣式',
                borderTopColor: '邊框頂部顏色',
                borderTopSize: '邊框最大尺寸',
                borderTopStyle: '邊框樣式',
                borderRightColor: '邊框右顏色',
                borderRightSize: '邊框右尺寸',
                borderRightStyle: '邊框右樣式',
                borderBottomColor: '邊框底色',
                borderBottomSize: '邊框底邊尺寸',
                borderBottomStyle: '邊框底樣式'
            }
        },
        size: {
            categoryName: '尺寸',
    ...
    publishReport: {
        ...
        addCategory: {
            ...
            emptyCategory: '请输入类别名称',
            saveCategoryError: '项目名称已存在',
            categoryCreateError: '無法將類別創建到服務器',
            saveCatgeory: '保存'
        },
        warningMessage: {
