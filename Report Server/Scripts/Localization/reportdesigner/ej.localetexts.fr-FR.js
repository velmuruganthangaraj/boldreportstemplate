ej.ReportDesigner.Locale['fr-FR'] = {
    ...
    imageProperty: {
        ...
        appearance: {
            ...
            borderStyle: {
                borderDefaultColor: 'Couleur de la bordure',
                borderDefaultSize: 'Taille de la frontière',
                borderDefaultStyle: 'Style de bordure',
                borderLeftColor: 'Couleur de bordure gauche',
                borderLeftSize: 'Bordure gauche taille',
                borderLeftStyle: 'Style de bordure gauche',
                borderTopColor: 'Couleur de la bordure',
                borderTopSize: 'Taille supérieure de la frontière',
                borderTopStyle: 'Style de bordure',
                borderRightColor: 'Couleur droite de la bordure',
                borderRightSize: 'Taille droite',
                borderRightStyle: 'Style de bordure droite',
                borderBottomColor: 'Couleur de fond de bordure',
                borderBottomSize: 'Taille inférieure de la frontière',
                borderBottomStyle: 'Style de fond de bordure'
            }
        },
        size: {
            categoryName: 'Taille',
    ...
    chartProperty: {
        ...
        axis: {
            ...
            lineStyles: {
                ...
                lineSize: 'La taille de la ligne',
                lineStyle: 'Style de trait'
            },
            gridLineStyles: {
                gridLineColor: 'Couleur de la grille',
                gridLineSize: 'Taille de la grille',
                gridLineStyle: 'Style de ligne de grille'
            },
            chartTicks: {
                tickLength: 'Longueur de la tique',
                tickWidth: 'Largeur Tick'
            }
        },
        gridLine: {
    ...
    publishReport: {
        ...
        closeToolTip: 'proche',
        addCategory: {
            categoryTitle: 'Nouvelle catégorie',
            categoryName: 'prénom',
            categoryDescription: 'La description',
            emptyCategory: 'Veuillez saisir le nom de la catégorie',
            saveCategoryError: 'Le nom de l\'article existe déjà',
            categoryCreateError: 'Failed to create category into server',
            saveCatgeory: 'sauver'
        },
        warningMessage: {
    ...
    codeDialog: {
        ...
        classes: {
            ...
            classSuffixTooltip: ' sur les classes RDL.'
        },
        code: {
            title: 'Code',
            ...
            codeSuffixToolTip: ' sur le module de code RDL.'
        },
