...
function MakeFlyDeleteUsers() {
    ...
    doAjaxPost("POST", deleteFromUserListUrl, values, function (data) {
        if (data.status) {
            ...
            parent.messageBox("su-open", window.Server.App.LocalizationContent.DeleteUser, window.Server.App.LocalizationContent.UserDeleteSuccess, "success", function () {
                var count = parent.$("#user-count-text").val();
            ...
            hideWaitingPopup("user-delete-confirmation");
            parent.messageBox("su-open", window.Server.App.LocalizationContent.DeleteUser, window.Server.App.LocalizationContent.UsersDeleteSuccess, "success", function () {
                $("#user-delete-confirmation").ejDialog("close");
                parent.onCloseMessageBox();
            });
        }
        ...
        hideWaitingPopup("user-delete-confirmation");
        parent.messageBox("su-open", window.Server.App.LocalizationContent.DeleteUser, window.Server.App.LocalizationContent.UsersDeleteSuccess, "error", function () {
            $("#user-delete-confirmation").ejDialog("close");
            parent.onCloseMessageBox();
        });
    });
